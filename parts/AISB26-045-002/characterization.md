...
重复字段：`n = 3 measurements per condition`。

## 丝绸染色与跨基材结果

丝绸对照使用 10 mL 乙醇和 0.5 mg astaxanthin；含 BmCBP 配方使用 2 mL 乙醇、0.5 mg astaxanthin、7.6 mL 水和 0.4 mL 的 2.6 mg/mL BmCBP。两组平行结果显示含 BmCBP 配方具有一致的洗后保色方向。棉和聚酯结果弱于丝绸，支持将丝绸列为当前优先基材。
